...
//       try {
//         const parsedUser = JSON.parse(storedUser);
//         // IMPORTANT: Ensure parsedUser has an 'id' property from your login response/JWT
//         if (parsedUser && parsedUser.id && parsedUser.token) {
//           setUser(parsedUser);
//         } else {
//           console.warn("User data in localStorage is incomplete (missing id or token). Clearing.");
//           localStorage.removeItem('user'); // Clear invalid data
//         }
//       } catch (e) {
//         console.error("Failed to parse user from localStorage", e);
...
//   const login = (userData) => {
//     // userData should now contain { id: ..., token: ..., role: ..., email: ... }
//     localStorage.setItem('user', JSON.stringify(userData));
//     setUser(userData);
//   };
